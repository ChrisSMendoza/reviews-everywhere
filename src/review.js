...
export const StarOutline = () => svg({ fill: "none", viewBox: "0 0 24 24", "stroke-width": "1.5", stroke: "currentColor", class: 'icon' },
    path({ 
...
export const StarSolid = () => svg({ viewBox: "0 0 24 24", fill: "currentColor", class: 'icon' },
    path({
...
export function CreateReviewForm() {
    const { form, input, label }  = van.tags;

    const reviewTextInput = input({ name: "text" });
    const inputWithLabel = label('Review text', reviewTextInput);
